...
import static com.wdullaer.materialdatetimepicker.date.DatePickerDialog.OnDateChangedListener;
import static com.wdullaer.materialdatetimepicker.date.DatePickerDialog.OnDateSetListener;
import static com.wdullaer.materialdatetimepicker.date.DatePickerDialog.ScrollOrientation;
import static com.wdullaer.materialdatetimepicker.date.DatePickerDialog.Version;
...
public class DatePickerFragment extends Fragment implements
    ...
    public static DatePickerFragment newInstance(int year, int monthOfYear, int dayOfMonth) {
        ...
        ret.initialize(year, monthOfYear, dayOfMonth);
        return ret;
    }
    ...
    public static DatePickerFragment newInstance() {
        ...
        return DatePickerFragment.newInstance(now);
    }

    @SuppressWarnings("unused")
    public static DatePickerFragment newInstance(Calendar initialSelection) {
        DatePickerFragment ret = new DatePickerFragment();
        ret.initialize(initialSelection);
        return ret;
    }

    public void initialize(Calendar initialSelection) {
    ...
    public void initialize(int year, int monthOfYear, int dayOfMonth) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        int viewRes = R.layout.mdtp_date_picker_fragment;
